...
When you use our contact forms or request quotes, we may collect:
- **Name** (required for contact forms)
- **Email address** (required for contact forms)
- **Phone number** (optional)
- **Inquiry type** (machinery, parts, partnership, support, other)
- **Message content** (your specific inquiry or request)
...
- Analyze website usage (if analytics are implemented)

## 4. How We Use Your Information

We use your personal data for the following purposes:

### 4.1 Business Communications
...
- **Legitimate Interest:** For business communications and website improvement
- **Consent:** When you voluntarily provide information through contact forms
- **Contract Performance:** To fulfill your requests for quotes and information

## 6. Data Storage and Security

### 6.1 Data Storage
- Your data is stored securely on our systems
- We implement appropriate technical and organizational measures
- Data is stored only as long as necessary for the purposes outlined
...
- **Service Providers:** With trusted third parties who assist in website operation (hosting, email services)
...
- **Hosting Services:** Website hosting and security
- **Email Services:** For sending responses to your inquiries
- **Analytics Services:** (If implemented) Website usage analysis

## 8. Data Retention

We retain your personal data for:
- **Contact Form Data:** Up to 3 years from last contact
- **Website Analytics:** Up to 2 years (if collected)
...
- File a complaint with the Greek Data Protection Authority
- Contact: Hellenic Data Protection Authority (HDPA)
...
Your data is primarily processed within Greece and the European Union. If we transfer data outside the EU, we ensure adequate protection through:
...
Our Website is not directed to children under 16. We do not knowingly collect personal information from children under 16. If you believe we have collected such information, please contact us immediately.
...
- **Analytics Cookies:** (If implemented) Website usage analysis
...
*This Privacy Policy is effective as of October 21, 2025, and may be updated from time to time. Please check this page regularly for any changes.*
