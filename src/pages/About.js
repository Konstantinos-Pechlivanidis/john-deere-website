          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Η Ι&Κ ΨΩΜΑ ιδρύθηκε το 1980 και από μια μικρή οικογενειακή
                επιχείρηση έχει εξελιχθεί σε έναν από τους κορυφαίους εισαγωγείς
                γεωργικών μηχανημάτων και ανταλλακτικών John Deere στην Ελλάδα.
              </p>
              <p className="text-gray-600 mb-4">
                Από την αρχή, στόχος μας ήταν να προσφέρουμε στους Έλληνες
                αγρότες εξοπλισμό υψηλής ποιότητας σε ανταγωνιστικές τιμές,
                δημιουργώντας ισχυρές συνεργασίες με παγκόσμιους προμηθευτές.
              </p>
              <p className="text-gray-600">
                Σήμερα, εξυπηρετούμε πελάτες σε όλη την Ελλάδα, από μικρές
                φάρμες μέχρι μεγάλες γεωργικές εταιρείες, διατηρώντας τη
                δέσμευσή μας στην ποιότητα και την εξαιρετική εξυπηρέτηση.
              </p>
            </div>
