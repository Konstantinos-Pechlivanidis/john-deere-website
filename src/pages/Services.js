      ...
      <div className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-4 text-charcoal-dark">{t('whyUs.title')}</h2>
              <div className="w-20 h-1 bg-jdyellow mb-6"></div>
              
              <ul className="space-y-4">
                {t('whyUs.benefits', { returnObjects: true }).map((benefit, i) => (
                  <li key={i} className="flex">
                    ...
                    <div>
                      <h3 className="font-bold text-lg mb-1 text-charcoal-dark">{benefit.title}</h3>
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-lg overflow-hidden shadow-xl">
                <img 
                  ...
                  alt={t('common:alt_texts.agricultural_machinery')} 
                  loading="lazy" 
